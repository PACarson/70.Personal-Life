 ...
 * 修复。未来任何新的 Conversion 设计时都要先对照这条原则检查一遍——
 * Task→Note（ADR-2026-09-02-030）就是这条原则确立之后第一次被完整
 * 套用的新增 Conversion，2026-09-04 已实现，不再是"尚未实现"的假设
 * 案例，见 00_Project_State.gs 对应交付章节。
 */
